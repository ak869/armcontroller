...
MIDL_DEFINE_GUID(IID, IID_IBusPortData,0x014BA2C5,0x63D4,0x469F,0x8A,0xFD,0xEC,0xDE,0xF4,0x2B,0x8B,0x63);
...
MIDL_DEFINE_GUID(CLSID, CLSID_BusPortData,0x903CD9C7,0x2FE2,0x4F2C,0x87,0x68,0x57,0x86,0x70,0x2B,0x9F,0x55);
